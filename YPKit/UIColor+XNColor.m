...
@interface UIColor (UIColor_XNColor_Support)
+ (UIColor *)searchForColorByName:(NSString *)cssColorName;
@end

#pragma mark -

@implementation UIColor (XNColor)
...
#pragma mark XNColor initialization
...
@implementation UIColor (UIColor_XNColor_Support)
/*
